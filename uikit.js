				...
				link: function (scope, element, attrs) {
					...
					if (scope.ctrl.actions.length) {
						...
						scope.ctrl.columns.push({
							...
							<md-icon aria-hidden="true">{{ action.icon }}</md-icon>{{action.title}}</md-button> \
